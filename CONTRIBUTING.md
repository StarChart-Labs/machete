...
- Fork the `machete` repository
- Clone your fork to your development machine
- Run `./gradlew clean build` to confirm you are starting from a working setup
  - Please report any issues with this build step in the project's [issues](https://github.com/StarChart-Labs/machete/issues)
